          ...
          >
            <img
              ...
              onError={(e) => {
                ...
                e.target.src = PLACEHOLDERS.GEDUNG;
              }}
            />
          </div>
          ...
          >
            <div className="border-l-4 border-secondary pl-6 space-y-4">
              <p className="text-lg text-gray-700 leading-relaxed">
                Program Studi Informatika Universitas Pancasakti Tegal merupakan
                salah satu program studi unggulan yang berfokus pada
                pengembangan kompetensi di bidang teknologi informasi.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Kami menyediakan pendidikan berkualitas dengan kurikulum yang
                selalu diperbarui mengikuti perkembangan industri dan kebutuhan
                dunia kerja.
              </p>
            </div>
